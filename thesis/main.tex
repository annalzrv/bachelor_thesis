...
The LC-PINN training and evaluation code is available at \texttt{thesis/code/} of the project repository. The ANOVA decomposition code is at \texttt{anova/lc\_anova/}. All experimental results in this thesis are reproducible from the committed checkpoints and the scripts under \texttt{thesis/code/scripts/}; per-experiment hyperparameters are recorded in the JSON output files alongside the rel-$L^2$ numbers.
