...
A short interpretability section computes the joint $(x, y, k)$ functional ANOVA decomposition of the trained 2D Helmholtz \LCPINN{}. The dominant subset is the three-way interaction $S_{xyk} = 0.43$ (bootstrap 95\,\% CI $[0.41, 0.44]$), which yields an exact rel-$L^2$ floor of $\sqrt{S_{xyk}} \approx 0.66$ on any pair-additive solver; verified to within $0.002$ absolute against the analytic projection at $N = 10^6$.

Source code: \url{https://github.com/annalzrv/bachelor_thesis}.
...
Краткий раздел по интерпретируемости вычисляет совместное $(x, y, k)$ ANOVA-разложение обученного 2D-Гельмгольц-\LCPINN{}. Доминирует тройное взаимодействие $S_{xyk} = 0{,}43$ (бутстрэп 95\,\% ДИ $[0{,}41, 0{,}44]$); это даёт точную нижнюю границу относительной $L^2$-ошибки парно-аддитивных решателей: $\sqrt{S_{xyk}} \approx 0{,}66$, подтверждённую с точностью до $0{,}002$ против аналитической проекции на $N = 10^6$.

Исходный код: \url{https://github.com/annalzrv/bachelor_thesis}.
